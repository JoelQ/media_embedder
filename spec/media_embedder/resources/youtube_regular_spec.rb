...
describe MediaEmbedder::Resource::YoutubeRegular do
  it 'accepts regular youtube links' do
    resource = MediaEmbedder::Resource::YoutubeRegular.new('http://www.youtube.com/watch?v=NSWOvw5N4nU')
